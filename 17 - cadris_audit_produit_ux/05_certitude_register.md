...
**Impact potentiel :** si 80% des utilisateurs sont en "Projet flou", le Flow 2 devient prioritaire et doit être implémenté avec la même robustesse que le Flow 1.
